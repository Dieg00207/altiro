      ...
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[hsl(var(--primary))]">
            <span className="font-display text-lg font-bold text-[hsl(var(--primary-foreground))]">P</span>
          </div>
          <span className="font-display text-xl font-bold text-[hsl(var(--foreground))]">PeerBet</span>
        </div>
